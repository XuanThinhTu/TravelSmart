                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="hotel_service_id" class="form-control">
                                                        <option value="">Select Hotel Service (Optional)</option>
                                                        @foreach($hotelServices as $hotelService)
                                                            <option value="{{ $hotelService->id }}">{{ $hotelService->id }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <select name="transport_service_id" class="form-control">
                                                        <option value="">Select Transport Service (Optional)</option>
                                                        @foreach($transportServices as $transportService)
                                                            <option value="{{ $transportService->id }}">{{ $transportService->id }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="total_price" value="{{ old('total_price') }}" class="form-control" required min="0">
                                                </div>
                                                <div class="form-group">
