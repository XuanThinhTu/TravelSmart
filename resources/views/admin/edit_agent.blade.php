                        ...
                        <div class="card o-hidden card-hover">
                            <div class="card-header border-0 pb-1">
                                <div class="card-header-title p-0">
                                    <h4>Edit Agent: {{ $agent->first_name }} {{ $agent->last_name }}</h4>
                                </div>
                            </div>
                            <div class="card-body p-0">
                                ...
                                <form method="POST" action="{{ route('update_agent', $agent->id) }}">
                                    @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="agent_code" value="{{ old('agent_code', $agent->agent_code) }}" class="form-control" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>First Name</label>
                                                    <input type="text" name="first_name" value="{{ old('first_name', $agent->first_name) }}" class="form-control" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Last Name</label>
                                                    <input type="text" name="last_name" value="{{ old('last_name', $agent->last_name) }}" class="form-control" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Status</label>
                                                    <select name="active" class="form-control" required>
                                                        <option value="Working" {{ old('active', $agent->active) == 'Working' ? 'selected' : '' }}>Working</option>
                                                        <option value="Retired" {{ old('active', $agent->active) == 'Retired' ? 'selected' : '' }}>Retired</option>
                                                    </select>
                                                </div>
