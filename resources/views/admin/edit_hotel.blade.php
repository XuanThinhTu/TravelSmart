                        ...
                        <div class="card o-hidden card-hover">
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="container mt-4">
                                    <form method="POST" action="{{ route('update_hotel', $hotel->id) }}">
                                        @csrf

                                        <div class="form-group">
                                            <label for="hotel_name">Hotel Name</label>
                                            <input type="text" name="hotel_name" id="hotel_name" class="form-control" value="{{ old('hotel_name', $hotel->hotel_name) }}" required>
                                            @error('hotel_name')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="city_id" id="city_id" class="form-control" required>
                                                ...
                                                @foreach($cities as $city)
                                                    <option value="{{ $city->id }}" {{ $hotel->city_id == $city->id ? 'selected' : '' }}>{{ $city->city_name }}</option>
                                                @endforeach
                                            </select>
                                            @error('city_id')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="hotel_address" id="hotel_address" class="form-control" value="{{ old('hotel_address', $hotel->hotel_address) }}" required>
                                            @error('hotel_address')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="details" id="details" class="form-control" rows="3">{{ old('details', $hotel->details) }}</textarea>
                                        </div>

                                        <div class="form-group">
                                            <label for="active">Status</label>
                                            <select name="active" id="active" class="form-control" required>
                                                <option value="Active" {{ $hotel->active == 'Active' ? 'selected' : '' }}>Active</option>
                                                <option value="Inactive" {{ $hotel->active == 'Inactive' ? 'selected' : '' }}>Inactive</option>
                                            </select>
                                            @error('active')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="available_from" id="available_from" class="form-control" value="{{ old('available_from', $hotel->available_from) }}" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="available_to" id="available_to" class="form-control" value="{{ old('available_to', $hotel->available_to) }}" required>
                                            @error('available_to')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
