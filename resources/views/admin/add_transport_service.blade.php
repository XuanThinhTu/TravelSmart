                        ...
                        <div class="card o-hidden card-hover">
                            <div class="card-header border-0 pb-1">
                                <div class="card-header-title p-0">
                                    <h4>Add New Transport Service</h4>
                                </div>
                            </div>
                            <div class="card-body p-0">
                                ...
                                <div class="card-body p-0">
                                    ...
                                    <form method="POST" action="{{ url('add_transport_service/save') }}">
                                        @csrf
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="ticket_type_id" class="form-control" required>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="service_price" value="{{ old('service_price') }}" class="form-control" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Status</label>
                                                    ...
                                                    <button type="submit" class="btn btn-primary mt-2">Add Transport Service</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
