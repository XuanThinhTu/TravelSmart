    ...
    <div class="header-wrapper m-0">
        <div class="header-logo-wrapper p-0">
            <div class="logo-wrapper">
                <a href="{{ url('/') }}">
                    <img class="img-fluid main-logo" src="{{ asset('Admin_template/images/logo/1.png') }}" alt="logo">
                    <img class="img-fluid white-logo" src="{{ asset('Admin_template/images/logo/1-white.png') }}" alt="logo">
                </a>
            </div>
            <div class="toggle-sidebar">
                <i class="status_toggle middle sidebar-toggle" data-feather="align-center"></i>
                <a href="{{ url('index.html') }}">
                    <img src="{{ asset('Admin_template/images/logo/1.png') }}" class="img-fluid" alt="">
                </a>
            </div>
        </div>
